...
mlds$`Alarm.Date.-.Hour.of.Day`<-as.numeric(mlds$`Alarm.Date.-.Hour.of.Day`)
...
mlds<-mlds%>%mutate(daycat=case_when(`Alarm.Date.-.Hour.of.Day` >= 5 & `Alarm.Date.-.Hour.of.Day` < 11 ~ "Morning",
                                     `Alarm.Date.-.Hour.of.Day` >= 11 & `Alarm.Date.-.Hour.of.Day` < 13 ~ "Mid-Day",
                                     `Alarm.Date.-.Hour.of.Day` >= 13 & `Alarm.Date.-.Hour.of.Day` < 18 ~ "Aft-Noon",
                                     `Alarm.Date.-.Hour.of.Day` >= 18 & `Alarm.Date.-.Hour.of.Day` < 21 ~ "Evening",
                                     `Alarm.Date.-.Hour.of.Day` >= 21 & `Alarm.Date.-.Hour.of.Day` < 24 ~ "Night",
                                     `Alarm.Date.-.Hour.of.Day` >= 0 & `Alarm.Date.-.Hour.of.Day` < 5 ~ "Night"))
...
fml<-mlds%>%select(-Property.Loss,-`Pre-Incident.Property.Value`, -Non.Fire.Service.Fatalities,-percloss, -`Alarm.Date.-.Hour.of.Day`)
...
set.seed(1234)
Model_DT2=rpart(Fatality~.,data=fml,method="class", control=rpart.control(minsplit=2, minbucket=1, cp=0.008))
